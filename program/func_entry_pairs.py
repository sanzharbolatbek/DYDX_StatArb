        ...
        if len(series_1) > 0 and len(series_1) == len(series_2):
            ...
            if abs(z_score) >= ZSCORE_THRESH:
                ...
                if not is_base_open and not is_quote_open:
                    ...
                    accept_failsafe_base_pairs = format_number(failsafe_base_price, base_tick_size)
                    ...
                    # ADD LOGIC FOR maxOrderSize if trade is large enough
                    ...
                    if check_base and check_quote:
                        ...
                        bot_agent = BotAgent(
                            ...
                            accept_failsafe_base_price= accept_failsafe_base_pairs,
                            z_score=z_score,
                            half_life=half_life,
